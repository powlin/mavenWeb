...
public abstract class RSAUtils {
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus,
        ...
        try {
            ...
            LOGGER
                .error("hexModulus or hexPrivateExponent value is invalid. return null(RSAPrivateKey).");
        }
    ...
    public static RSAPublicKey getRSAPublidKey(String hexModulus,
        ...
        if (StringUtils.isBlank(hexModulus)
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER
                    .debug("hexModulus and hexPublicExponent cannot be empty. return null(RSAPublicKey).");
            }
            return null;
        }
        byte[] modulus = null;
        ...
        try {
            ...
            LOGGER
                .error("hexModulus or hexPublicExponent value is invalid. return null(RSAPublicKey).");
        }
