...
$(function() {
	...
	$('#tableList').bootstrapTable({
		method : "get",
		url : $("#base_path").val() + "/account/frozenMoneyList",
		height : $(window).height() - 120,
		striped : true,
		singleSelect : true,
		queryParams : function(params) {
			return {
				fjNo : $("#fj_no_search").val(),
	...
	$('#searchBtn').click(function() {
		$('#tableList').bootstrapTable('refresh',{url: $("#base_path").val() + "/account/frozenMoneyList"});
	});
});
				...
				<div id="custom-toolbar" style="margin-bottom: 8px">
					<div class="form-inline" role="form">
						<div class="form-group mr40 mt10">
							<label for="fjNo" class="control-label-first">冻结编号:</label> <input class="input-sm" type="text"
								class="form-control" id="fj_no_search" placeholder="请输入冻结编号">
						</div>
						<div class="form-group mr40 mt10">
							<label for="refNo" class="control-label-first">参考订单号:</label> <input class="input-sm" type="text"
								class="form-control" id="ref_no_search" placeholder="请输入参考订单号">
						</div>
						<div class="form-group mr40 mt10">
